...
- `ambient` (Attributes) Ambient noise threshold. One of 'level' or 'quality' must be provided. (see [below for nested schema](#nestedatt--item--conditions--threshold--water--ambient))

<a id="nestedatt--item--conditions--threshold--water--ambient"></a>
### Nested Schema for `item.conditions.threshold.water.ambient`
...
- `ambient` (Attributes) Ambient noise threshold. One of 'level' or 'quality' must be provided. (see [below for nested schema](#nestedatt--items--conditions--threshold--water--ambient))

<a id="nestedatt--items--conditions--threshold--water--ambient"></a>
### Nested Schema for `items.conditions.threshold.water.ambient`
